...
def get_retriever(icl_method, data, dataset_name, index_split="train", test_split="test"):
    dataset_ice_nums = {"sst2": 16, "ag_news": 6, "toxigenic": 6, "disaster_tweets": 32, "wilds_civil_comments": 16, "civil_toxigen": 16, "rotten_tomatoes_imdb": 16, "wilds_amazon": 16, "scotus": 4}
...
def get_prompt_template(dataset_name):
    dataset_num_labels = {"sst2": 2, "ag_news": 4, "toxigen": 2, "disaster_tweets": 2, "wilds_civil_comments": 2, "civil_toxigen": 2, "rotten_tomatoes_imdb": 8, "wilds_amazon": 5, "scotus": 11}
